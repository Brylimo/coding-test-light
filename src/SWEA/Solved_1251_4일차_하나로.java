 ...
 *
 * 문제 요약
 * 당신은 인도네시아 내의 N개의 섬을 연결하는 하나로 프로젝트를 맡게 되었고 인도네시아 내의 모든 섬을 해저터널로 연결해야 한다.
 * 다만, 해저터널 건설로 인해 파괴되는 자연을 위해 환경 부담금 정책이 있다.
 * 총 환경 부담금을 최소로 지불하며 N개의 모든 섬을 연결할 수 있는 교통 시스템을 설계해야 한다.
 *
 * 아이디어
 * 환경 부담금을 최소로 지불하고 N개의 섬을 모두 연결해야 하기 때문에 MST를 이용하여 최소 환경 부담금을 구해야 한다.
 *
 * 풀이
 ...
 *
 * 참고문서
 * https://sskl660.tistory.com/72 (크루스칼 알고리즘 설명)
 *
 */
